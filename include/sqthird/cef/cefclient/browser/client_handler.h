...
class ClientHandler : public CefClient,
 ...
 public:
  ...
  class Delegate {
   public:
	...
	virtual bool OnProcessMessageReceived(CefRefPtr<CefProcessMessage> message) { return false; };

	// Called when the browser is created.
	virtual void OnLoadOver(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
		int httpCode,
	...
	// New popup window.
	virtual void OnPopup(CefRefPtr<CefBrowser> browser,
		CefRefPtr<CefFrame> frame, const std::string& target_url) = 0;
 ...
 private:
  ...
  void NotifyPopup(CefRefPtr<CefBrowser> browser,
	  CefRefPtr<CefFrame> frame, const CefString& title);
